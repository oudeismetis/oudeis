...
# Invalidate cache
aws cloudfront create-invalidation --profile ${PROFILE} --distribution-id ${DISTRIBUTION_ID} --paths /index.html /blog/index.html /projects/index.html /about/index.html
